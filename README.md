...
**⚠️ Notice: If you don't use Windows, you can skip Step 1 and start on Step 2.** Step 1 is for Windows users to install UNIX-like terminal that is sustainable for work, while Linux and MacOS already have one.
